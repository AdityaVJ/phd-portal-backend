...
class SupervisorAuthController extends Controller
{
    ...
    protected string $guard = 'supervisor';
    ...
    public function refresh(Request $request)
    {
        ...
        $user = Supervisor::find($token->user_id);
    ...
    public function forgot(Request $request)
    {
        ...
        DB::table('supervisor_password_reset_tokens')->updateOrInsert(
            ['email' => $request->email],
            [
                'email' => $request->email,
    ...
    public function reset(Request $request)
    {
        ...
        $record = DB::table('supervisor_password_reset_tokens')
        ...
        // Delete reset record
        DB::table('supervisor_password_reset_tokens')->where('email', $request->email)->delete();
